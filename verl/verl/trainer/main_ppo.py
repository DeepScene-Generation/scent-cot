...
class RewardManager(NaiveRewardManager):
    """The reward manager.
    """
    ...
    def __call__(self, data: DataProto):
        ...
        def process_item(args):
            ...
            score = compute_score_fn(data_source=data_source, llm_solution=response_str, extra_info=extra_info, retrieval=self.retrieval)
